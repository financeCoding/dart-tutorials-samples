...
void init_autogenerated() {
  ...
  __e3 = _root.nodes[3].nodes[1].nodes[1];
  ...
  __t.conditional(__e12, () => !dead && !won, (__t) {
    ...
    __t.listen(__e6.onKeyUp, ($event) { $event = new KeyEvent($event); checkit(); });
    ...
    __t.loop(__e10, () => wrongletters, ($list, $index, __t) {
      var usedchars = $list[$index];
      var __binding9 = __t.contentBind(() => usedchars, false);
    __t.addAll([new autogenerated.Text(' '),
        __binding9,
        new autogenerated.Text(' ')]);
    });
